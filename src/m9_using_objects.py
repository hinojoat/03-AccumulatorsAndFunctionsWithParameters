...
def two_circles():
    ...
    """
    # -------------------------------------------------------------------------
    # TODO Question: 2. Implement this function, per its green doc-string above.
...
def lines():
    ...
    point1 = rg.Point(500, 50)
    point2 = rg.Point(300, 60)
    point3 = rg.Point(550, 300)
